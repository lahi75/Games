...
namespace MonkeyMadness
{
    public class MMButton
    {
        ...
        public MMButton(Game gameMain, string text, bool checkButton, bool radioButton)
        {
            _textureDefault = gameMain.Content.Load<Texture2D>("buttons/button_default");
            _textureHover = gameMain.Content.Load<Texture2D>("buttons/button_default_hover");
            _texturePressed = gameMain.Content.Load<Texture2D>("buttons/button_pressed");
            _textureHoverPressed = gameMain.Content.Load<Texture2D>("buttons/button_pressed_hover");          
            _text = text;
            ...
            _hoverNoise = gameMain.Content.Load<SoundEffect>("sound/beep-29");
