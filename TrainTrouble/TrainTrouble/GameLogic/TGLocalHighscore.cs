...
namespace TGGameLibrary
{
    ...
    {       
        ...
        public TGLocalHighscore()
        {
        }

        public TGLocalHighscore(TGLocalHighscore serializedObject)
        {
    ...
    static class LocalHighscoreManager
    {
        ...
        /// </summary>
        public static TGLocalHighscore Highscore = new TGLocalHighscore();
        ...
        public static void LoadSettings()
        {
            ...
            Highscore = new TGLocalHighscore();
            ...
            if (fileStorage.FileExists(fileName))
            {
                ...
                try
                {
                    Highscore = new TGLocalHighscore((TGLocalHighscore)serializer.Deserialize(stream));
                    stream.Close();
                }
                catch
                {
