...
namespace LLGameLibrary
{
    public class LLButton
    {
        ...
        public LLButton(ContentManager Content, string text, bool checkButton, bool radioButton)
        {
            _textureDefault = Content.Load<Texture2D>("buttons/button_default");
            _textureHover = Content.Load<Texture2D>("buttons/button_default");
            _texturePressed = Content.Load<Texture2D>("buttons/button_pressed");
            _textureHoverPressed = Content.Load<Texture2D>("buttons/button_pressed");          
            _text = text;
