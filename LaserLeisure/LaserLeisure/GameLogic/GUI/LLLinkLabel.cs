...
namespace LLGameLibrary
{
    class LLLinkLabel
    {
        ...
        public LLLinkLabel(ContentManager content, String text, String action, String param, Color defaultColor, Color hoverColor, Task task)
        {
            _font = content.Load<SpriteFont>("fonts/LLTexture");
